...
class ProfileUpdateForm(forms.ModelForm):
    class Meta:
        model = Profile
        fields = ['profile_pic', 'username', 'dob', 'first_name', 'last_name', 'country']
        widgets = {
            'dob': forms.DateInput(attrs={'type': 'date', "placeholder": "Date Of Birth", "class": "form-control"}),
            'profile_pic': forms.ClearableFileInput(attrs={"placeholder": "Profile Picture", "class": "photo-profile__cta btn btn-primary btn-sm btn-pill"}),
    ...
    # Add a choice field for country
    COUNTRY_CHOICES = [
      ("AD", "Andorra (+376)"),
    ...
    country = forms.ChoiceField(choices=COUNTRY_CHOICES, required=True, widget=forms.Select(
        attrs={"placeholder": "country", "class": "form-control"}), label="Country")
